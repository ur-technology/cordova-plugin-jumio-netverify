...
- (void) netverifyViewController: (NetverifyViewController *) netverifyViewController didFinishWithDocumentData: (NetverifyDocumentData *)documentData scanReference: (NSString *) scanReference
{
    ...
    if(documentData.subdivision)[documentDataDictionary setObject: documentData.subdivision forKey: @"subdivision"];
    if(documentData.addressLine)[documentDataDictionary setObject: documentData.addressLine forKey: @"addressLine"];

    if(documentData.postCode)[documentDataDictionary setObject: documentData.postCode forKey: @"postalCode"];
...
- (void)configureNetswipeControllerAppearence:(CDVInvokedUrlCommand *)command{
    ...
    if([appearenceConfig objectForKey: @"submitButtonBackgroundColorNormal"])
        [[NetswipePositiveButton appearanceWhenContainedIn:[NetswipeViewController class], nil] setBackgroundColor: [self colorFromHexString: [appearenceConfig objectForKey: @"submitButtonBackgroundColorNormal"]] forState:UIControlStateNormal];
    if([appearenceConfig objectForKey: @"submitButtonBackgroundColorHighlighted"])
        [[NetswipePositiveButton appearanceWhenContainedIn:[NetswipeViewController class], nil] setBackgroundColor: [self colorFromHexString: [appearenceConfig objectForKey: @"submitButtonBackgroundColorHighlighted"]] forState:UIControlStateHighlighted];
    if([appearenceConfig objectForKey: @"submitButtonBackgroundColorDisabled"])
        [[NetswipePositiveButton appearanceWhenContainedIn:[NetswipeViewController class], nil] setBackgroundColor: [self colorFromHexString: [appearenceConfig objectForKey: @"submitButtonBackgroundColorDisabled"]] forState:UIControlStateDisabled];

    if([appearenceConfig objectForKey: @"submitButtonTitleColorNormal"])
        [[NetswipePositiveButton appearanceWhenContainedIn:[NetswipeViewController class], nil] setTitleColor:[self colorFromHexString: [appearenceConfig objectForKey: @"submitButtonTitleColorNormal"]] forState:UIControlStateNormal];
    if([appearenceConfig objectForKey: @"submitButtonTitleColorHighlighted"])
        [[NetswipePositiveButton appearanceWhenContainedIn:[NetswipeViewController class], nil] setTitleColor:[self colorFromHexString: [appearenceConfig objectForKey: @"submitButtonTitleColorHighlighted"]] forState:UIControlStateHighlighted];
    if([appearenceConfig objectForKey: @"submitButtonTitleColorDisabled"])
        [[NetswipePositiveButton appearanceWhenContainedIn:[NetswipeViewController class], nil] setTitleColor:[self colorFromHexString: [appearenceConfig objectForKey: @"submitButtonTitleColorDisabled"]] forState:UIControlStateDisabled];
...
- (NSDictionary*) allNetswipeCreditCardTypeToStringCode {
    return [[NSDictionary alloc] initWithObjectsAndKeys:
            @"ALL", [NSNumber numberWithInt: NetswipeCreditCardTypeAll],
            ...
            @"STAR_BUCKS", [NSNumber numberWithInt: NetswipeCreditCardTypeStarbucks],
